...
import io.ingpleb.plebtrolls.prompt.TrollSearchPrompt;
import io.ingpleb.plebtrolls.settings.Settings;
import io.ingpleb.plebtrolls.troll.Troll;
import io.ingpleb.plebtrolls.util.Interval;
...
public final class TrollPlayerMenu extends MenuPagged<Troll> {
	...
	public TrollPlayerMenu(Menu parentMenu, @NotNull Player target, @NotNull Player viewer) {
		...
		this.targetInfoButton = Button.makeDummy(ItemCreator.of(CompMaterial.PLAYER_HEAD)
				...
				.lore(io.ingpleb.plebtrolls.util.PlayerUtil.getTargetInfo(target))
